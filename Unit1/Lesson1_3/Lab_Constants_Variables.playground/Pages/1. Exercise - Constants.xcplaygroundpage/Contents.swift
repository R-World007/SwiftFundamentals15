...
//friends = 200 // constants cannot be changed
...
print("This code does not compile because 'friends' is declared with 'let', which makes it a constant. It is new for me bc in other programming languages let is not const.")
