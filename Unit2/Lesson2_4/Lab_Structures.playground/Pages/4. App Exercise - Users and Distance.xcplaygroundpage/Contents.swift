...
var saiMoeHein = User(name: "Sai Moe Hein", age: 21, height: 175.0, weight: 70.0, activityLevel: 8)
print("Name: \(saiMoeHein.name), Age: \(saiMoeHein.age), Height: \(saiMoeHein.height) cm, Weight: \(saiMoeHein.weight) kg, Activity Level: \(saiMoeHein.activityLevel)/10")
...
let runDistance = Distance(feet: 3280.84) // 1000 meters
print(runDistance.meters)
print(runDistance.feet)
