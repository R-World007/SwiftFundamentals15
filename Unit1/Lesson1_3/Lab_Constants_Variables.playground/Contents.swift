 ...
 */
//friends = 200   //an error because constants cannot be changed
 ...
 */
print("The code does not compile because 'friends' is a constant declared with let and cannot be reassigned.")
