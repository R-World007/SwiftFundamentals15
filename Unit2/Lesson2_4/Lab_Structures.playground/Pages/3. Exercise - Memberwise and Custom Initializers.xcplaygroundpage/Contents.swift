...
print("My favorite book is \(favoriteBook.title) by \(favoriteBook.author), \(favoriteBook.pages) pages, priced at $\(favoriteBook.price).")
/*:
...
let macbook2 = Laptop(screenSize: 15, repairCount: 2, yearPurchased: 2018)
...
print(someonesHeight.heightInCentimeters) // 165.1
